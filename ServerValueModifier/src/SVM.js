...
class MainSVM
{
	preAkiLoad(container)
	{
		...
		/*StaticRouterModService.registerStaticRouter("BotGen", [{
					...
					for (const currentRepeatablePool of pmcData.RepeatableQuests){
						...
						if (newRepeatableQuest) {
							...
							currentRepeatablePool.changeRequirement[newRepeatableQuest._id] = {
								changeCost: newRepeatableQuest.changeCost * Config.Quests.QuestCostMult,
								changeStandingCost: this.randomUtil.getArrayValue([
										0,
										0.01
									])
							};
							if(Config.Quest.QuestRepToZero)
							{
		...
		// 	  if (Config.Scav.EnableScavHealth)
		// 	  {
		// 		  scavData.Health.BodyParts["Head"].Health.Maximum = Config.Scav.ScavHealth.Head
		// 		  scavData.Health.BodyParts["Chest"].Health.Maximum = Config.Scav.ScavHealth.Chest
		// 		  scavData.Health.BodyParts["Stomach"].Health.Maximum = Config.Scav.ScavHealth.Stomach
		// 		  scavData.Health.BodyParts["LeftArm"].Health.Maximum = Config.Scav.ScavHealth.LeftArm
		// 		  scavData.Health.BodyParts["LeftLeg"].Health.Maximum = Config.Scav.ScavHealth.LeftLeg
		// 		  scavData.Health.BodyParts["RightArm"].Health.Maximum = Config.Scav.ScavHealth.RightArm
		// 		  scavData.Health.BodyParts["RightLeg"].Health.Maximum = Config.Scav.ScavHealth.RightLeg
		// 		  //Because default health will not be increased
		// 		  scavData.Health.BodyParts["Head"].Health.Current = Config.Scav.ScavHealth.Head
		// 		  scavData.Health.BodyParts["Chest"].Health.Current = Config.Scav.ScavHealth.Chest
		// 		  scavData.Health.BodyParts["Stomach"].Health.Current = Config.Scav.ScavHealth.Stomach
		// 		  scavData.Health.BodyParts["LeftArm"].Health.Current = Config.Scav.ScavHealth.LeftArm
		// 		  scavData.Health.BodyParts["LeftLeg"].Health.Current = Config.Scav.ScavHealth.LeftLeg
		// 		  scavData.Health.BodyParts["RightArm"].Health.Current = Config.Scav.ScavHealth.RightArm
		// 		  scavData.Health.BodyParts["RightLeg"].Health.Current = Config.Scav.ScavHealth.RightLeg
		// 	  }
		// 	  if(Config.Scav.ScavCustomPockets)
		// 	  {
		// 		  scavData.Inventory.items.forEach((item) =>
	 ...
	 postDBLoad(container)
	{
		...
		*/
		...
		Logger.log(`SVM 1.8.1 has initialized, ` + funni[Math.floor(Math.random() * funni.length)],"blue");
		...
		if (Config.Bots.EnableBots)
		{
			...
			// locations["sandbox"].base.MaxBotPerZone = Config.Bots.BotSpawn.SandboxSPZ;
			...
			// Bots.maxBotCap.sandbox = Config.Bots.BotSpawn.SandboxLimit;
		...
		{
			Logger.debug("SVM:Services settings enabled")
		...
		// 	// 	}
		// 	// }
		// 	if(Config.PMC.PMCOverride)
		// 	{
		// 		Bots.equipment.pmc.randomisation[0].levelRange.max = 1;
		// 	}
			
		// 	// if (Config.PMC.AddAllKeys || Config.PMC.AddAllContainers)
		// 	// {
